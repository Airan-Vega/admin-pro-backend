...
router.get("/", [], async_middleware_1.wrap(medicoController.getMedicos));
router.post("/", [
...
router.put("/:id", [], async_middleware_1.wrap(medicoController.actualizarMedico));
router.delete("/:id", [], async_middleware_1.wrap(medicoController.borrarMedico));
